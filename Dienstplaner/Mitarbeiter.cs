...
namespace Dienstplaner.Models
{
    public class Mitarbeiter
    {
        ...
        public decimal Iststunden { get { return Schichten.Sum(x => x.NettoDauerInStunden); } }
        public decimal Pausenstunden { get { return Schichten.Sum(x => x.Pausenstunden); } }
        public decimal Zuschlagsstunden { get { return Schichten.Sum(x => x.Zuschlagsstunden); } }
        public decimal Ueberstunden { get { return Iststunden > SollstundenProWoche ? Iststunden - SollstundenProWoche : 0; } }
